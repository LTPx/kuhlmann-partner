    ...
    <div className="flex flex-col">
      ...
      <div className="container">
        ...
        <section className="pt-[21px] lg:pt-[58px]">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 pt-[25px] lg:pt-[45px]">
            <div className="flex flex-col lg:w-[532px] gap-[22px] lg:gap-[50px]">
              <div className="flex flex-col">
            ...
            <div className="flex flex-col pt-[22px] lg:pt-[0px] lg:w-[574px] gap-[22px] lg:gap-[50px]">
              <div className="flex flex-col">
                <p className="font-semiBold">Asesoramiento integral:</p>
                <p className="font-regular">
                  Contamos con un equipo de arquitectos e interioristas
        ...
        <section className="pt-[20px] lg:pt-[40px] pb-[30px] lg:pb-[0px]">
          <img src="" className="object-cover h-[270px] lg:h-[965px] w-full" />
        </section>
      </div>
    </div>
  );
