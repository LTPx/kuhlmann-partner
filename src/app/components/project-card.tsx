  ...
  return (
    <div className="flex flex-col gap-[15px] lg:gap-[0px] lg:grid lg:grid-cols-2 lg:h-[850px]">
      ...
      <div className={`relative ${className}`}>
        <img
          src={image}
          className={`h-[500px] lg:h-[850px] w-full object-cover transition-opacity duration-500 ease-in-out transform ${
        ...
        {imageHover && (
          <img
            src={imageHover}
            alt="image-hover"
            className="h-[850px] w-full object-cover opacity-0 group-hover:opacity-100 transition-opacity duration-500"
          />
        )}
      </div>
