...
export function ProjectDetails(props: ProjectDetailsProps) {
  ...
  return (
    <div className="flex flex-col">
      <div className="grid grid-cols-2">
        ...
        <div className="">
          <p className="font-regular w-[665px] text-[20px] leading-[28px]">
            ...
            Además, se sustituyeron todas las instalaciones eléctricas y
            tuberías de agua, y se instaló una moderna bomba de calor para
      ...
      <section className="pt-[30px] pb-[65px]">
